	...
	return (
		...
		>
			<div className="mx-auto flex w-full max-w-7xl items-center justify-between">
				...
				<div ><a href="https://github.com/akash2061" target="_blank"><img src={github} style={{ height: '30px', width: '30px' }} /></a></div>
				<div><a href="https://www.linkedin.com/in/akash-soni-01475924b/" target="_blank"><img src={linkedin} style={{ height: '40px', width: '40px' }} /></a></div>
